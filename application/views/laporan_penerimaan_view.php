...
<!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
        Rekap Laporan Penerimaan Barang Bulanan 
        <small>Control panel</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url(); ?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Rekap Laporan Penerimaan Barang Bulanan</li>
      </ol>
    </section>
...
<!-- column -->
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="<?php echo base_url('laporan_pdf/laporan_penerimaan_action')?>" method="post" class="form-horizontal">
