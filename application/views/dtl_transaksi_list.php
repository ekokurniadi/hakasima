...
<!-- Content Header (Page header) -->
    ...
    <section class="content">
      ...
      <?php if ($data->status=='3') { ?>
        ...
        <?php 
				echo anchor(site_url('transaksi/detail_transaksi/'.$data->kode_transaksi),'<i class="fa fa-eye"></i>',array('title'=>'detail','class'=>'btn btn-warning btn-sm')); 
				echo '  '; 
				echo anchor(site_url('transaksi/cetak_nota/'.$data->kode_transaksi),'<i class="fa fa-print"></i>',array('title'=>'detail','class'=>'btn btn-default btn-sm')); 
				echo '  '; 
				?>
			</td>
		</tr></tbody>
