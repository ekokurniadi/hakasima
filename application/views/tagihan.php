    ...
    <section class="content">
      <div class="row">
        ...
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('tagihan_konsumen/create'),'Create', 'class="btn btn-primary"'); ?>
            </div>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('tagihan_konsumen/listnya/'.$tagihan_konsumen->id_prospek),'<i class="fa fa-eye"></i>',array('title'=>'detail','class'=>'btn btn-default btn-sm')); 
				echo '  '; 
