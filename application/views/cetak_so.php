...
<style>
	...
	<table class="table">
		<tr>
			<td colspan="2" align="left" style="font-size: 15pt"><b>SALES ORDER</b></td>
		</tr>
		<tr>
	...
	<table width="100%" border="0">
		...
		<tr>
			<td colspan="7">2. Surat Pesanan ini dianggap SAH apabila ditandatangani Sales Person, dan Kepala Cabang.</td>
		</tr>
		<!-- <tr>
        ...
        <?php $ku=$this->db->query("select nama_lengkap from sales where nik='$sales_order_data->nik_sales'")->row();?>
		<tr>
            
			<td style="padding-left:30px;"align="center"><br><br></td>
			<td style="padding-left:80px;" colspan="2" align="center"><br><br>(<?php echo $ku->nama_lengkap ?>)</td>
			<td style="padding-left:80px;" colspan="2" align="center"><br><br>(PIMPINAN)</td>			
		</tr>
