		...
		<div class="agile_info">
			<div class="w3l_form">
				<div class="left_grid_info">
					...
					<p>Hakasima Official Store
					</p>
					<img src="<?php echo base_url()?>image/shopi.jpg" alt="" />
				</div>
			</div>
			<div class="w3_info">
				...
				<p class="account1">Belum memiliki akun? <a href="<?php echo base_url('auth_sales/register')?>">Daftar disini</a></p>
			</div>
		</div>
		<!-- //main content -->
	</div>
