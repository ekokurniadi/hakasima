    ...
    <section class="content">
      <div class="row">
        ...
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('pembayaran'),'<i class="fa fa-eye"></i> View Data', 'class="btn bg-maroon btn-flat"'); ?>
            </div>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('pembayaran/read/'.$pembayaran->id),'<i class="fa fa-eye"></i>',array('title'=>'detail','class'=>'btn btn-default btn-sm')); 
				echo '  '; 
				echo anchor(site_url('pembayaran/cetak/'.$pembayaran->id),'<i class="fa fa-print"></i>',array('title'=>'edit','class'=>'btn btn-warning btn-sm','target'=>'_blank')); 
				echo '  '; 
