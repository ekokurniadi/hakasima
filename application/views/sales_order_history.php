    ...
    <section class="content">
      <div class="row">
        ...
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('sales_order'),'<i class="fa fa-eye"></i> View Data', 'class="btn bg-maroon btn-flat"'); ?>
            </div>
		...
		<th>Action</th>
			...
			<td><span class="badge bg-green"><?php echo $sales_order->status ?></span></td>
			<td><?php echo $sales_order->nik_sales ?></td>
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('sales_order/read/'.$sales_order->id),'<i class="fa fa-eye"></i>View',array('title'=>'detail','class'=>'btn btn-default btn-flat btn-block btn-sm')); 
				echo '  '; 
				echo anchor(site_url('sales_order/cetak/'.$sales_order->id),'<i class="fa fa-floppy-o"></i> Cetak',array('title'=>'edit','class'=>'btn btn-info btn-flat btn-block btn-sm','target'=>'_blank')); 
				echo '  '; 
				// echo anchor(site_url('sales_order/delete/'.$sales_order->id),'<i class="fa fa-trash-o"></i>','title="delete" class="btn btn-danger btn-sm" onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr></tbody>
                <?php
